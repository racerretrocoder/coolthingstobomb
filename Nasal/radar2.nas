...
var Radar = {
    new: func(){
        var m = { parents : [Radar]};
        m.loop_running  = 0;
        m.rangeTab      = [5, 10, 20, 40, 60, 160, 300, 320, 5000]; # radar Ranges in nm
        m.rangeIndex    = 8; # tab starts at index 1 so here it's 5000
        ...
        m.HaveDoppler       = 1;
        m.DopplerSpeedLimit = 5000; # in Knot
...
#                    screen.log.write("checked!");
    ...
    isGroundNotBehind: func(SelectedObject){
        ...
        if(myPitch < 0 and me.NotBeyondHorizon(SelectedObject))
        {
            ...
            GroundNotBehind = (distHorizon > horizon);   #      GroundNotBehind = (distHorizon > horizon);
        }
        return GroundNotBehind;
        print(GroundNotBehind);
    },
